...
"$BT/apksigner" sign --ks keystore.jks --ks-pass pass:mtprotofinder --key-pass pass:mtprotofinder --out MTProto-Finder-v0.1.2.0.apk
"$BT/apksigner" verify MTProto-Finder-v0.1.2.0.apk && echo "OK: MTProto-Finder-v0.1.2.0.apk"
